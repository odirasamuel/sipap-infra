# WhatsApp Auth Handler Lambda Module
# Creates a Lambda function for authenticating WhatsApp messages before SQS
...
# Lambda function
resource "aws_lambda_function" "whatsapp_auth" {
...
resource "aws_lambda_permission" "api_gateway" {
  ...
  function_name = aws_lambda_function.whatsapp_auth.function_name
