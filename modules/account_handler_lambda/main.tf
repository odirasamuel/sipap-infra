# Account Handler Lambda Module
# Creates a Lambda function for retrieving user account information
# Requires VPC access for Aurora database connectivity
...
# Lambda function
resource "aws_lambda_function" "account_handler" {
...
resource "aws_lambda_permission" "api_gateway" {
  ...
  function_name = aws_lambda_function.account_handler.function_name
