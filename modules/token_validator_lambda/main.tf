# Token Validator Handler Lambda Module
# Creates a Lambda function for validating registration tokens and checking user status
# Integrated with API Gateway for /auth endpoints
